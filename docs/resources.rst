...
<html lang="en">
  <head>
    ...
    <title>CSDS Distance Matrices</title>
  </head>
  <body>
    ...
    .tg {margin:auto;width:50%!important;margin-top:30px;margin-bottom:30px}
    .td {margin:auto;width:50%!important;margin-top:10px;margin-bottom:10px;font-family:Arial, sans-serif}
    .center {display:block;margin:auto;width:30%;text-align:center;}
    </style>

  <h2 class="td">Download Distance Matrices</h2>
  <p class="td">
  This page hosts point-to-point distance matrices generated by the Center for Spatial Data Science.
  The matrices come as bzipped CSVs, structured using the <a href="https://github.com/dfsnow/otp-routing#outputs">format shown here</a>.
  ...
  For a full list of origin and destination locations + attached populations, see the CSDS Box folder <a href="https://uchicago.box.com/v/csds-otp-data">here</a>.
  </p>
  <table class="tg">
    <tr>
  ...
  <a href="https://github.com/dfsnow/otp-routing#extracting-a-subset-of-tracts-or-blocks">here</a>.
  </p>
  <p class="td">
  These matrices were generated primarily using <a href="https://www.opentripplanner.org/">OpenTripPlanner (OTP)</a> and Docker. The necessary containers can be found
  <a href="https://github.com/dfsnow/otp-routing">here</a> and <a href="https://github.com/dfsnow/otp-resources">here</a> and are also available on
  <a href="https://cloud.docker.com/u/snowdfs">Dockerhub</a>. All matrices were generated with the following settings using all land-based GTFS feeds available in a given county buffer, including e.g. buses, subways, and lightrail (no ferries are included):
  </p>
  <table class="tg">
    <tr>
  ...
  <img class="center" src="https://geoda.s3.amazonaws.com/data/otp/icons/csds_logo.png"/>
  </body>
