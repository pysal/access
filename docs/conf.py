...
#
# The full version.
version = access.__version__ #should replace it with your access
release = access.__version__ #should replace it with your access
...
html_theme_options = {
    ...
    'navbar_title': "access", # string of your project name, for example, 'giddy'
...
latex_documents = [
    (master_doc, 'access.tex', u'access Documentation',
...
man_pages = [
    (master_doc, 'access', u'access Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'access', u'access Documentation',
     author, 'access', 'One line description of project.',
     'Miscellaneous'),
]
