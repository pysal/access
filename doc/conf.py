...
#
# The full version.
version = PACKAGE_NAME.__version__ #should replace it with your PACKAGE_NAME
release = PACKAGE_NAME.__version__ #should replace it with your PACKAGE_NAME
...
html_theme_options = {
    ...
    'navbar_title': "PACKAGE_NAME", # string of your project name, for example, 'giddy'
